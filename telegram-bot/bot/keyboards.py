...
BOT_USERNAME = os.getenv("BOT_USERNAME", "ArtiLectAIbot").lstrip("@")
...
def open_app_kb() -> InlineKeyboardMarkup:
        ...
        """
    # Requested deep link: include addToHomeScreen
    deep_link = f"https://t.me/{BOT_USERNAME}/?startapp&addToHomeScreen"
