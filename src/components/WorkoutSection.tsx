...
<Dialog open={showNewProgram} onOpenChange={setShowNewProgram}>
  <DialogContent className="w-[92vw] sm:max-w-md p-4 sm:p-6 rounded-2xl max-h-[88vh] overflow-y-auto">
...
<Dialog open={showProgramDetails} onOpenChange={setShowProgramDetails}>
  <DialogContent className="w-[92vw] sm:max-w-3xl p-4 sm:p-6 max-h-[88vh] overflow-hidden rounded-2xl">
    <DialogHeader className="pb-2">
...
<Dialog open={showAddExercise} onOpenChange={setShowAddExercise}>
  <DialogContent className="w-[92vw] sm:max-w-md p-4 sm:p-6 max-h-[88vh] overflow-y-auto rounded-2xl">
    <DialogHeader className="pb-2">
